...
class MCOCMaps:
    ...
    aq_map_tips = {
        ...
        '5.3':{'required':'',
            ...
            'tips':''},
        '6':{},
        '6.1':{'required':'Path A - 2 players\nPath B - 2 players\nPath F - Power Control\nPath G - 2 players',
            'energy':'Paths D & E move first\nPaths B, C, F, G move next\nPath A moves last.',
            'tips':'Path A - Defense Ability Reduction for tile 22.\nPaths D & E - Defense Ability Reduction for THORNS 14, Regen for tile 19, 20.\nPath F - Power control for All or Nothing 9, Defensive Ability Reduction for tile 10.\nPath G - Daredevil for Enhanced Raged Specials.'},
        '6.2':{'required':'Paths A - - 2 players, Poison Immune\nPath B - Poison Immune\nPath G - Power control\nPaths H - Bleed Immune\nPath I - 2 players, Bleed Immune',
            'energy': 'Paths A, B, E, H, & I move first\nPaths D, F, G move next\nPath C moves last',
            'tips':'Paths A & B - Poison Immune\nPath C - High Block Proficiency for Immunity enemies\nPath E -High Block Proficiency for Stun Immune tile 61\nPath F- Regen for tile tiles 49, 50, 51\nPath G - Power control for Power Gains and All or Nothing tiles.\nPaths H & I -Bleed Immune\nPaths A, B, C, D, & E - Daredevil for Enhanced range special tiles 73, 63.'},
        '6.3':{'required':'Path A - Poison Immune\nPaths B & C - Bleed Immune\nPath I - Power control\nPath J - Regeneration',
            'energy':'Paths D & E move first\nPaths C & F move second\nPaths A, B, G & I move third\nPaths H & J move last',
            'tips':'Path A - Poison Immune\nPaths B & C - Regneration for Degeneration & Starburst\nPath I - Power Control for Power gains\nPath J - Regeneration for Starburst\nPaths A, B, C - Power control for All or Nothing tile 118\nPaths F & J - Regeneration for tiles 79, 83'},
    }
