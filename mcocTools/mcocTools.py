...
class MCOCTools:
    ...
    async def _alliance_popup(self, ctx, *args):
        ...
        admin = await self.bot.create_role(server=server, name='admin', permissions=None, color=discord.Color.gold(), hoist=False, mentionable=False)
        officers = await self.bot.create_role(server=server, name='officers', permissions=None, color=discord.Color.light_grey(), hoist=False, mentionable=True)
        ...
        alliance = await self.bot.create_role(server=server, name='alliance',  permissions=None, color=discord.Color.teal(), hoist=True, mentionable=True)
        summoners = await self.bot.create_role(server=server, name='Summoners',  permissions=None, color=discord.Color.white(), hoist=True, mentionable=True)
    # @checks.admin_or_permissions(manage_server=True, manage_roles=True)
