...
spotlight_json='https://spreadsheets.google.com/feeds/list/1I3T2G2tRV05vQKpBfmI04VpvP5LjCBPfVICDmuJsjks/1/public/values?alt=json'
spotlight_data=requests.get(spotlight_json).json()
