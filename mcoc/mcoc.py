...
class MCOC(ChampionFactory):
    ...
    async def mastery_info(self, ctx, word: str, rank:int = None):
        ...
        if found:
            ...
            unlocks = {'ucarbs': '<:carbcore:527924990159355904>} Carbonium Core(s)', 'uclass': ' {} Core(s)'.format(classcores[key] if key in classcores.keys()), 'ustony': '<:stonycore:416405764937089044> Stony Core(s)', 'uunits': '<:units:344506213335302145> Units'}
            ...
            embedcolor = colors[cdt_masteries[key]['class'].lower()]
